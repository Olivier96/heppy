...
import heppy.ttbar_analysis.ANALYSIS.PYTHIA.python_samplers.ee_ttbar_splitmtop_1730_12_sampler as samples


n_cores = 8*40
samples.ttbar.splitFactor = n_cores
...
# The arguments below the class TreeTTSemilep are input to give the class
tree = cfg.Analyzer(
    TreeTTSemilep,
    mc_lepton = 'mc_lepton',
